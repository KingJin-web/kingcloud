...
import com.king.kingcloud.entity.IPEntry;
...
//            } else {
//                logger.error("qqwry.dat not found");
            ipFile = new RandomAccessFile(new File("/king/springboot/cloud/db/qqwry.dat"), "r");
            //}
...
//            System.out.println(Objects.requireNonNull(IPSeeker.class.getResource("/QQWry.dat")).toString());
    ...
    public static void main(String[] args) {
        ...
        list.add("8.8.8.8");
        logger.info(ips.getAddress(list).toString());
